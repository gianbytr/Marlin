...
#define STRING_CONFIG_H_AUTHOR "Gianby" // Who made the changes.
...
#define TEMP_SENSOR_BOARD 0		//QUESTO E' NUOVO
...
// Enable for Polargraph Kinematics TUTTA QUESTA SEZIONE E' NUOVA
//#define POLARGRAPH
...
#define I_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.// NUOVO
#define J_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.// NUOVO
#define K_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.// NUOVO
